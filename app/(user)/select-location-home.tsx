...
export default function SelectLocationHomeScreen() {
  ...
  const detectLocation = async () => {
    ...
    try {
      ...
      console.warn("Could not fetch location for home map:", err);
    } finally {
      setLocating(false);
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Set Delivery Area</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <View style={styles.bottomCard}>
        <View style={styles.addressRow}>
          ...
          <View style={styles.addressTextCol}>
            <Text style={styles.addressLabel}>Current Area</Text>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.9}
        >
          <Text style={styles.confirmBtnText}>Show Nearby Home Cooks</Text>
